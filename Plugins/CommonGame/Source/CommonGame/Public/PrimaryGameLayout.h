...
public:
	...
	/** LayerName에 따른 ActivatableWidgetContainerBase를 반환 */
	...
	{
		static_assert(TIsDerivedFrom<ActivatableWidgetT, UCommonActivatableWidget>::IsDerived, "only CommonActivatableWidgets can be here");
